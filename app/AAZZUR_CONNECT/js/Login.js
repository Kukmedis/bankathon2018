    ...
    render() {
        return (
            ...
            style = {{backgroundColor: 'white', width: '100%', height: '100%', justifyContent: 'center', alignItems: 'center'}}>
                ...
                }} style = {{position: 'absolute', bottom: 16, width: '80%', height: 30, marginTop: 10, backgroundColor: !this.state.userName ? '#D8D8D8FF' : colors.blue, elevation: 2, justifyContent: 'center'}}>
